...
--inscrits = lain.widgets.abase({
--    timeout  = 120,
--    cmd      = "inscrits",
--    settings = function() 
--        widget:set_markup(markup("#f1af5f", output))
--    end
--})
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "q",      function() awful.util.spawn("shutdown now") end),
